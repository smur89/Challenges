// Ammonite 2.3.8, scala 2.12.10
// cs launch io.github.alexarchambault.ammonite::ammonite-runner-cli:latest.release -- arbitrage.sc
import $ivy.`com.github.valskalla::odin-core:0.11.0`
import $ivy.`org.typelevel::squants:1.7.4`
import $ivy.{`org.http4s::http4s-blaze-client:0.21.21`, `org.http4s::http4s-circe:0.21.21`, `org.http4s::http4s-dsl:0.21.21`}
